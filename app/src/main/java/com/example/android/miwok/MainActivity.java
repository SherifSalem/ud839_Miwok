...
TextView numbersActivity, familyActivity, phrasesActivity, colorsActivity;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //finds the views of the different activities
        ...
        familyActivity = (TextView) findViewById(R.id.family);
